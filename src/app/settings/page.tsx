  ...
  return (
    <div className="flex flex-col min-h-screen bg-black">
      <header className="px-5 pt-5 pb-4 border-b border-[#1a1a1a] flex-shrink-0">
        <h1 className="font-mono text-[18px] font-semibold text-white tracking-[0.06em]">
          Settings
        </h1>
      ...
      <div>
        ...
        <div className="flex items-center px-5 py-[15px] border-b border-[#0f0f0f] gap-3">
          <div className="flex-1">
            ...
            <p className="font-mono text-[10px] text-[#444] mt-0.5">Reading body size</p>
          </div>
      ...
      <div>
        ...
        <div className="flex items-center px-5 py-[15px] border-b border-[#0f0f0f] gap-3">
          ...
          <Toggle on={settings.showRecentFiles} onToggle={() => update('showRecentFiles', !settings.showRecentFiles)} />
        </div>
        ...
        <div className="flex items-center px-5 py-[15px] border-b border-[#0f0f0f] gap-3">
          ...
          <Toggle on={settings.autoReload} onToggle={() => update('autoReload', !settings.autoReload)} />
        </div>
      </div>
      ...
      <button
        onClick={handleClear}
        className="mx-5 mt-5 border border-[#1e1e1e] p-4 flex items-center justify-between hover:border-[#333] transition-colors"
      >
        <div>
      ...
      {/* Version footer */}
      <p className="mt-auto px-5 py-4 font-mono text-[10px] text-[#2a2a2a] tracking-widest">
